...
let DataDialog = {};
 ...
 /**
     ...
     *
     * @param {string} dir - The direction parameter to be sent to the server.
     * @returns The response from the server.
     * 
     * DataDialog.request permet de récupérer des données depuis le serveur.
     * Elle prend en paramètre une direction (dir) et renvoie les données contenues
     * dans la réponse du serveur (data).
     */
DataDialog.request = async function(dir){
    // fetch permet d'envoyer une requête HTTP à l'URL spécifiée. 
    // L'URL est construite en concaténant HOST_URL à "/server/script.php?direction=" et la valeur de la variable dir. 
    // L'URL finale dépend de la valeur de HOST_URL et de dir.
    let answer = await fetch(HOST_URL + "/server/script.php?direction=" + dir);
